...
import org.junit.runner.RunWith;
    ...
    //this particular class allows cucumber to execute the code:
...
@CucumberOptions(
        ...
        features = "src/test/resources/features/", //same path will work for every other employee.same path for one frame
